...
export default function FAQ(): JSX.Element {
    ...
    const wildcardRules = (
        <div className="space-y-2">
            <p>A <code className="bg-[var(--shadcn-ui-app-muted)] text-[var(--shadcn-ui-app-foreground)] px-2 py-0.5 rounded text-sm font-mono border border-[var(--shadcn-ui-app-border)]">*.ads-example.com</code> entry will match subdomains, like <code className="bg-[var(--shadcn-ui-app-muted)] text-[var(--shadcn-ui-app-foreground)] px-2 py-0.5 rounded text-sm font-mono border border-[var(--shadcn-ui-app-border)]">ads1.ads-example.com</code> and <code className="bg-[var(--shadcn-ui-app-muted)] text-[var(--shadcn-ui-app-foreground)] px-2 py-0.5 rounded text-sm font-mono border border-[var(--shadcn-ui-app-border)]">ads2.ads-example.com</code>, but <code className="bg-[var(--shadcn-ui-app-muted)] text-[var(--shadcn-ui-app-foreground)] px-2 py-0.5 rounded text-sm font-mono border border-[var(--shadcn-ui-app-border)]">ads-example.com</code> will still be permitted, unless there is a specific entry for <code className="bg-[var(--shadcn-ui-app-muted)] text-[var(--shadcn-ui-app-foreground)] px-2 py-0.5 rounded text-sm font-mono border border-[var(--shadcn-ui-app-border)]">ads-example.com</code>.</p>
            <p>The 'Settings' &gt; 'BLOCKLISTS' &gt; 'Subdomains' blocking option is enabled by default, and will block the domain plus all subdomains. For example, with the option enabled, <code className="bg-[var(--shadcn-ui-app-muted)] text-[var(--shadcn-ui-app-foreground)] px-2 py-0.5 rounded text-sm font-mono border border-[var(--shadcn-ui-app-border)]">ads-example.com</code> blocks <code className="bg-[var(--shadcn-ui-app-muted)] text-[var(--shadcn-ui-app-foreground)] px-2 py-0.5 rounded text-sm font-mono border border-[var(--shadcn-ui-app-border)]">ads-example.com</code> plus <code className="bg-[var(--shadcn-ui-app-muted)] text-[var(--shadcn-ui-app-foreground)] px-2 py-0.5 rounded text-sm font-mono border border-[var(--shadcn-ui-app-border)]">ads1.ads-example.com</code> and <code className="bg-[var(--shadcn-ui-app-muted)] text-[var(--shadcn-ui-app-foreground)] px-2 py-0.5 rounded text-sm font-mono border border-[var(--shadcn-ui-app-border)]">ads2.ads-example.com</code> and every other subdomain.</p>
            <p>This option is also available on the 'Custom Rules' page via the quick menu in the top-right corner of the page, next to the profile selector.</p>
            <p>A trailing * is not supported. For country-based domains, like <code className="bg-[var(--shadcn-ui-app-muted)] text-[var(--shadcn-ui-app-foreground)] px-2 py-0.5 rounded text-sm font-mono border border-[var(--shadcn-ui-app-border)]">ads-example.ch</code> and <code className="bg-[var(--shadcn-ui-app-muted)] text-[var(--shadcn-ui-app-foreground)] px-2 py-0.5 rounded text-sm font-mono border border-[var(--shadcn-ui-app-border)]">ads-example.us</code>, one entry per domain is required.</p>
        </div>
    );

    const dotRules = (
        <ul className="list-disc pl-5 space-y-1">
            <li>A leading dot is not permitted</li>
