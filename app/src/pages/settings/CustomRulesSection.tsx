...
interface CustomRulesSectionProps {
    customRulesSettings: { title: string; description: string; options: { value: string; label: string; icon?: string }[]; value: string }[];
    handleCustomRulesSettingsChange: (idx: number, value: string) => void;
}

const CustomRulesSection: React.FC<CustomRulesSectionProps> = ({
    customRulesSettings,
    handleCustomRulesSettingsChange,
}) => (
                    ...
                    {customRulesSettings.map((setting, index) => (
                        ...
                        >
                            ...
                            <ToggleGroup
                                ...
                                value={setting.value}
                                onChange={value => handleCustomRulesSettingsChange(index, value)}
                                variant="outline"
