        ...
        <CardContent className="bg-transparent">
            <div className="flex flex-col items-start gap-6 w-full">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between w-full gap-4 flex-wrap">
                    ...
                    >
                        <Trash2 className="w-4 h-4 text-[var(--tailwind-colors-slate-50)]" />
                        <span className="font-text-sm-leading-6-medium font-[number:var(--text-sm-leading-6-medium-font-weight)] text-[var(--tailwind-colors-slate-50)] text-[length:var(--text-sm-leading-6-medium-font-size)] tracking-[var(--text-sm-leading-6-medium-letter-spacing)] leading-[var(--text-sm-leading-6-medium-line-height)] break-words [font-style:var(--text-sm-leading-6-medium-font-style)]">Delete profile</span>
                    </Button>
                </div>
            </div>
        </CardContent>
