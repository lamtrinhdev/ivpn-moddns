...
class ProtocolCredentialParameter(BaseModel):
    """
    ProtocolCredentialParameter
    """ # noqa: E501
    alg: Optional[WebauthncoseCOSEAlgorithmIdentifier] = None
    type: Optional[ProtocolCredentialType] = None
    __properties: ClassVar[List[str]] = ["alg", "type"]
